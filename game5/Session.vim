...
set nomodeline
set ruler
set runtimepath=~/.vim,~/.vim/pack/mypackage/start/winresizer,~/.vim/pack/mypackage/start/vim-sneak,~/.vim/pack/mypackage/start/tcomment_vim,~/.vim/pack/mypackage/start/lexima.vim,~/.vim/pack/mypackage/start/indentLine,~/.vim/pack/mypackage/start/emmet-vim,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vim80/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/pack/mypackage/start/indentLine/after
set shiftwidth=2
set showmatch
set showtabline=2
set smartindent
...
badd +3 Input2.java
badd +5 Judge2.java
badd +1 TreasureNumber.java
badd +1 ~/works/dream/game5
badd +1 HitandBlow.java
badd +0 \!/bin/bash\ (1)
argglobal
silent! argdel *
$argadd Janken.java
edit HitandBlow.java
...
exe 'vert 1resize ' . ((&columns * 74 + 112) / 224)
exe '2resize ' . ((&lines * 22 + 24) / 48)
exe 'vert 2resize ' . ((&columns * 84 + 112) / 224)
exe '3resize ' . ((&lines * 22 + 24) / 48)
exe 'vert 3resize ' . ((&columns * 84 + 112) / 224)
exe 'vert 4resize ' . ((&columns * 64 + 112) / 224)
argglobal
...
17
normal! 0
lcd ~/works/dream/game5
wincmd w
argglobal
if bufexists('~/works/dream/game5/Input2.java') | buffer ~/works/dream/game5/Input2.java | else | edit ~/works/dream/game5/Input2.java | endif
inoremap <buffer> <nowait> <silent>  =lexima#insmode#escape()
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
wincmd w
argglobal
if bufexists('~/works/dream/game5/TreasureNumber.java') | buffer ~/works/dream/game5/TreasureNumber.java | else | edit ~/works/dream/game5/TreasureNumber.java | endif
inoremap <buffer> <nowait> <silent>  =lexima#insmode#escape()
setlocal keymap=
setlocal noarabic
setlocal noautoindent
